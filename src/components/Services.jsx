export default function Services() {
  /*Arreglo con la informacion de la lista de servicios que ofrece gaspa*/
  const servicesList = [
    ...
    { id: 3, title: "Control de Emisiones", description: "Análisis y dictaminación de emisiones a la atmósfera, evaluación de calidad del aire y licencias de funcionamiento.", icon: (<svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" /></svg>) },
    { id: 4, title: "Aguas Residuales", description: "Estudios y dictámenes para el uso, aprovechamiento y descarga de aguas residuales cumpliendo los parámetros oficiales.", icon: (<svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>) },
