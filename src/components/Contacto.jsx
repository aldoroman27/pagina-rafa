          ...
          <div className="mb-12 lg:mb-0 space-y-8">
            <div className="bg-slate-50 border border-slate-200 p-8 rounded-2xl">
              ...
              <div className="mt-8 pt-8 border-t border-slate-200">
                <a href="https://wa.me/523333746051" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-3 w-full bg-[#25D366] hover:bg-[#1ebd5a] text-white px-6 py-4 rounded-xl font-bold transition-all shadow-md hover:shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="">Capacitación a personal</option>
